...
# Easy to Paddle
python c_j_k_match_top_10.py --lang ko_paddle_easy --save_output ./c_j_k_match_top_10_ko_paddle_easy --homo --lev --fuzzychinese --simstring --multilang_dir multilang_results

python c_j_k_match_top_10.py --lang ja_paddle_easy --save_output ./c_j_k_match_top_10_ja_paddle_easy --homo --multilang_dir multilang_results --lev --fuzzychinese --simstring

python c_j_k_match_top_10.py --lang zhs_easy_paddle_80000 --save_output ./c_j_k_match_top_10_zhs_easy_paddle_80000_expand_final --homo --multilang_dir multilang_results_gcv --lev --fuzzychinese --simstring
...
python aggregate_accuracy_easy_2_gt.py
python aggregate_accuracy_paddle_2_gt.py

'''
Run TK and PR matching example
'''
python rule_based_homo_lev_fuzzyChineseStroke.py --homo --simstring --fuzzychinese --lev --match_task [['eff_2_efftk','effocr_partner','effocr_tk_title_dup_68352_clean_path.json','eff']] --save_output ./tk_title_partner_paddle_easy_dict_test_set

python rule_based_homo_lev_fuzzyChineseStroke.py --homo --simstring --fuzzychinese --lev --match_task [['easy_2_paddlepr','easy_ocr_partner','paddleocr_pr_title.json','cjk'], ['easy_2_easypr','easy_ocr_partner','easyocr_pr_title.json','cjk'], ['paddle_2_paddlepr','paddle_ocr_partner','paddleocr_pr_title.json','cjk'],]] --save_output ./pr_title_partner_paddle_easy_dict_debugged
